...
import threading # this is for multiple proccess 
...
class GUI:
    ...
    def receive_message_from_server(self, so):
        while True:
            ...
            if "joined" in message:
                ...
                message =  "New participant " + user +" has been added"
    ...
    def display_name_section(self):
        frame = Frame()
        Label(frame, text='Join the chat:', font=("Helvetica", 16)).pack(side='left', padx=10)
    ...
    def display_chat_box(self):
        frame = Frame()
        Label(frame, text='Box chat:', font=("Arial black", 12)).pack(side='top', anchor='w')
        self.chat_transcript_area = Text(frame, width=60, height=10, font=("Arial black", 12))
    ...
    def display_chat_entry_box(self):
        frame = Frame()
        Label(frame, text='write a message:', font=("Arial black", 12)).pack(side='top', anchor='w')
